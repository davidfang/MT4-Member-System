...
echo form_open('admin/message/edit',$attr);
?>
...
<label for="title"><span class="label label-important">标题</span></label>
	...
	<div class="controls">
		<?php 
		$data = array('name'=>'login_submit','id'=>'login_submit','value'=>'保存','class'=>'btn btn-primary','style'=>'margin:10px 200px');
		echo form_submit($data);
		?>
	</div>
<?php echo form_close()?>
<script type="text/javascript">
	$("#editor").append(<?php echo "'" . $message['content'] . "'" ?>);
